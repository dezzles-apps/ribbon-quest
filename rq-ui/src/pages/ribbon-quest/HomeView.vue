  ...
  <v-sheet rounded elevation="2">
    <div class="d-flex mx-auto px-4">
      ...
      <div class="content">
        The rules:
        <ul>
          <li>I must select a Pokemon from each region, and it must be named</li>
          <li>I must try to collect as many ribbons as I can for each Pokemon</li>
          <li>I can ignore unobtainable ribbons</li>
          <li>I can ignore ribbons that require long streaks in battle towers</li>
          <li>IF a Pokemon has a new form introduced in a region, that Pokemon can be used for that region.
            (This is mostly to let me use Galarian Ponyta TBH)
          </li>
        </ul>
      </div>
      <div>
